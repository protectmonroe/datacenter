...
export default function Home() {
  ...
  A massive data center project is being considered outside Sweetwater, TN.<br/><br/>When they decide to build, things start moving FAST. <br className="md:hidden"/><br className="md:hidden"/>We need the County Commission to vote for a <span className="font-bold underline">1 year pause on all data center projects</span> while we get the facts.
  </p>
  </div>
